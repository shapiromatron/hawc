...
class TestTryGetDoi:
    def test_valid(self):
        ...
        assert (
            try_get_doi("before10.1016/j.anifeedsci.2017.11.014</ArticleId>")
            == "10.1016/j.anifeedsci.2017.11.014"
        )
        assert (
            try_get_doi("before10.1016/j.anifeedsci.2017.11.014</ELocationID>")
            == "10.1016/j.anifeedsci.2017.11.014"
        )
        assert (
        ...
        assert try_get_doi("https://doi.org/10.1037/arc0000014.") == "10.1037/arc0000014"
