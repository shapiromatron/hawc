...
function peg$parse(input, options) {
  ...
  function peg$f0(left, right) {return options.orValues(left, right);  }
  function peg$f1(left, right) {return options.andValues(left, right);  }
  function peg$f2(value) {return options.negateValue(value);  }
  function peg$f3(query) {return query;  }
  function peg$f4(integer) {return options.getValue(parseInt(integer.join(""), 10));  }
