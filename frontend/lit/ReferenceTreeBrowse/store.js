...
class Store {
    ...
    @action.bound requestSelectedReferences() {
        ...
        let url = `/lit/api/assessment/${this.config.assessment_id}/references/?tag_id=${this.selectedTag.data.pk}`;
    ...
    @action.bound handleUntaggedReferenceClick() {
        ...
        let url = `/lit/api/assessment/${assessment_id}/references/?tag_id=untagged`;
        if (search_id) {
