...
class ExperimentPermissions(TestCase):
    ...
    def test_read_failure(self):
        ...
        views = [
            {
                "view": reverse(
                    "animal:experiment_detail", kwargs={"pk": self.experiment_final.pk}
                ),
                "status": 200,
            },
            {
                "view": reverse(
                    "animal:experiment_detail", kwargs={"pk": self.experiment_working.pk},
                ),
                "status": 403,
            },
        ]
    ...
    def test_crud_success(self):
        ...
        for client in clients:
            ...
            self.assertTrue(response.status_code == 200)
            response = c.post(
                reverse("animal:experiment_new", kwargs={"pk": self.study_working.pk}), exp_post,
            )
            ...
            self.assertTrue(response.status_code == 200)
            response = c.post(reverse("animal:experiment_update", kwargs={"pk": pk}), exp_post)
            self.assertTemplateUsed("animal/experiment_detail.html")
...
class AnimalGroupPermissions(TestCase):
    ...
    def test_read_failure(self):
        ...
        views = [
            {
                "view": reverse(
                    "animal:animal_group_detail", kwargs={"pk": self.animal_group_final.pk},
                ),
                "status": 200,
            },
            {
                "view": reverse(
                    "animal:animal_group_detail", kwargs={"pk": self.animal_group_working.pk},
                ),
                "status": 403,
            },
        ]
    ...
    def test_crud_success(self):
        ...
        for client in clients:
            ...
            # edit
            response = c.get(reverse("animal:animal_group_update", kwargs={"pk": pk}))
            self.assertTrue(response.status_code == 200)
            response = c.post(
                reverse("animal:animal_group_update", kwargs={"pk": pk}),
                {
                    "experiment": self.experiment_working.pk,
                    "name": "animal group name",
                    "species": self.species.pk,
            ...
            # delete
            response = c.get(reverse("animal:animal_group_delete", kwargs={"pk": pk}))
            self.assertTrue(response.status_code == 200)
...
class EndpointPermissions(TestCase):
    ...
    def test_read_success(self):
        ...
        views = [
            ...
            reverse(
                "animal:assessment_endpoint_taglist",
                kwargs={"pk": self.assessment_working.pk, "tag_slug": "foo"},
            ),
            reverse(
                "animal:assessment_endpoint_taglist",
                kwargs={"pk": self.assessment_final.pk, "tag_slug": "foo"},
            ),
    ...
    def test_read_failure(self):
        ...
        views = [
            {
                "view": reverse("animal:endpoint_list", kwargs={"pk": self.assessment_working.pk}),
                "status": 403,
            },
            {
                "view": reverse("animal:endpoint_list", kwargs={"pk": self.assessment_final.pk}),
                "status": 200,
            },
            {
                "view": reverse(
            ...
            {
                "view": reverse("animal:endpoint_detail", kwargs={"pk": self.endpoint_working.pk}),
                "status": 403,
            },
            {
                "view": reverse("animal:endpoint_detail", kwargs={"pk": self.endpoint_final.pk}),
                "status": 200,
            },
        ]
        for view in views:
