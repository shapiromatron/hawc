  ...
  main.variable(observer("graphic")).define("graphic", ["d3","gears","gear"], function(d3,gears,gear)
{
  ...
  main.define("initial angle", function(){return(
0
)});
  ...
  main.define("initial frameAngle", function(){return(
0
)});
  ...
  main.variable(observer("update")).define("update", ["graphic","mutable angle","speed","mutable frameAngle"], function*(graphic,$0,speed,$1)
{
  ...
  main.variable(observer("gears")).define("gears", ["x","y"], function(x,y){return(
[
...
Math.cos(2 * Math.PI / 3)
  ...
  main.variable(observer("toothRadius")).define("toothRadius", function(){return(
0.008
)});
  main.variable(observer("holeRadius")).define("holeRadius", function(){return(
0.02
)});
  main.variable(observer("speed")).define("speed", function(){return(
0.2
)});
  main.variable(observer("gear")).define("gear", ["toothRadius","holeRadius"], function(toothRadius,holeRadius){return(
