...
urlpatterns = [
    # experiment
    url(r"^study/(?P<pk>\d+)/create-experiment/$", views.ExperimentCreate.as_view(), name="experiment_create",),
    ...
    # chemical
    url(r"^study/(?P<pk>\d+)/create-chemical/$", views.ChemicalCreate.as_view(), name="chemical_create",),
    ...
    # cell types
    url(r"^study/(?P<pk>\d+)/create-cell-type/$", views.CellTypeCreate.as_view(), name="celltype_create",),
    url(r"^cell-type/(?P<pk>\d+)/$", views.CellTypeDetail.as_view(), name="celltype_detail",),
    url(r"^cell-type/(?P<pk>\d+)/update/$", views.CellTypeUpdate.as_view(), name="celltype_update",),
    url(r"^cell-type/(?P<pk>\d+)/delete/$", views.CellTypeDelete.as_view(), name="celltype_delete",),
    # endpoint categories
    url(
    ...
    url(r"^experiment/(?P<pk>\d+)/create-endpoint/$", views.EndpointCreate.as_view(), name="endpoint_create",),
    ...
    url(r"^assessment/(?P<pk>\d+)/full-export/$", views.EndpointFullExport.as_view(), name="endpoints_export",),
