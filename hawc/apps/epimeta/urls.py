...
urlpatterns = [
    ...
    # protocol views
    url(r"^study/(?P<pk>\d+)/protocol/create/$", views.MetaProtocolCreate.as_view(), name="protocol_create",),
    url(r"^protocol/(?P<pk>\d+)/$", views.MetaProtocolDetail.as_view(), name="protocol_detail",),
    url(r"^protocol/(?P<pk>\d+)/update/$", views.MetaProtocolUpdate.as_view(), name="protocol_update",),
    url(r"^protocol/(?P<pk>\d+)/delete/$", views.MetaProtocolDelete.as_view(), name="protocol_delete",),
    # result views
    url(r"^assessment/(?P<pk>\d+)/export/$", views.MetaResultFullExport.as_view(), name="result_export",),
    url(r"^assessment/(?P<pk>\d+)/results/$", views.MetaResultList.as_view(), name="result_list",),
    url(r"^protocol/(?P<pk>\d+)/result/create/$", views.MetaResultCreate.as_view(), name="result_create",),
    url(
