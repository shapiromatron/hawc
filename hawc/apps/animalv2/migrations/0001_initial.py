# Generated by Django 5.0 on 2023-12-19 20:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "effect_modifier_timing",
                    models.CharField(blank=True, max_length=128),
                ),
                (
                    "effect_modifier_reference",
                    models.CharField(blank=True, max_length=128),
                ),
                (
                    "effect_modifier_anatomical",
                    models.CharField(blank=True, max_length=128),
                ),
                (
                    "effect_modifier_location",
                    models.CharField(blank=True, max_length=128),
                ),
