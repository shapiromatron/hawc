...
class Result(models.Model):
            ...
            .agg(
                {
                    ...
                    "measured chemical": unique_list_items,
                    "measurement metric": unique_list_items,
                    "system": unique_items,
                    "effect": unique_items,
    ...
    def heatmap_df(cls, assessment: Assessment, published_only: bool) -> pd.DataFrame:
        ...
        columns = {
            ...
            "comparison_set__exposure__measured": "measured chemical",
            "comparison_set__exposure__metric": "measurement metric",
