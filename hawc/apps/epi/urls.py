...
urlpatterns = [
    ...
    re_path(r"^exposure/(?P<pk>\d+)/$", views.ExposureDetail.as_view(), name="exp_detail"),
    re_path(r"^exposure/(?P<pk>\d+)/update/$", views.ExposureUpdate.as_view(), name="exp_update",),
    re_path(r"^exposure/(?P<pk>\d+)/delete/$", views.ExposureDelete.as_view(), name="exp_delete",),
    # Outcome
    re_path(
        r"^assessment/(?P<pk>\d+)/outcomes/$", views.OutcomeList.as_view(), name="outcome_list",
    ),
    re_path(
    ...
    re_path(r"^outcome/(?P<pk>\d+)/$", views.OutcomeDetail.as_view(), name="outcome_detail"),
    re_path(
        r"^outcome/(?P<pk>\d+)/update/$", views.OutcomeUpdate.as_view(), name="outcome_update",
    ),
    re_path(
        r"^outcome/(?P<pk>\d+)/delete/$", views.OutcomeDelete.as_view(), name="outcome_delete",
    ),
    # Results
    re_path(
    ...
    re_path(r"^result/(?P<pk>\d+)/$", views.ResultDetail.as_view(), name="result_detail"),
    re_path(r"^result/(?P<pk>\d+)/update/$", views.ResultUpdate.as_view(), name="result_update",),
    re_path(r"^result/(?P<pk>\d+)/delete/$", views.ResultDelete.as_view(), name="result_delete",),
    # Comparison set
    re_path(
    ...
    re_path(
        r"^comparison-set/(?P<pk>\d+)/$", views.ComparisonSetDetail.as_view(), name="cs_detail",
    ),
    re_path(
    ...
    re_path(r"^group/(?P<pk>\d+)/$", views.GroupDetail.as_view(), name="g_detail"),
    re_path(r"^group/(?P<pk>\d+)/update/$", views.GroupUpdate.as_view(), name="g_update"),
]
