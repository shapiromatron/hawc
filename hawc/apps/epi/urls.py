...
urlpatterns = [
    ...
    # Study population
    url(r"^study/(?P<pk>\d+)/study-population/create/$", views.StudyPopulationCreate.as_view(), name="sp_create",),
    url(
        r"^study/(?P<pk>\d+)/study-population/copy-as-new-selector/$",
        views.StudyPopulationCopyAsNewSelector.as_view(),
        name="sp_copy_selector",
    ),
    url(r"^study-population/(?P<pk>\d+)/$", views.StudyPopulationDetail.as_view(), name="sp_detail",),
    url(r"^study-population/(?P<pk>\d+)/update/$", views.StudyPopulationUpdate.as_view(), name="sp_update",),
    url(r"^study-population/(?P<pk>\d+)/delete/$", views.StudyPopulationDelete.as_view(), name="sp_delete",),
    # Exposure
    url(r"^study/(?P<pk>\d+)/exposure/create/$", views.ExposureCreate.as_view(), name="exp_create",),
    url(
    ...
    url(r"^study-population/(?P<pk>\d+)/outcome/create/$", views.OutcomeCreate.as_view(), name="outcome_create",),
    url(
    ...
    # Results
    url(r"^outcome/(?P<pk>\d+)/result/create/$", views.ResultCreate.as_view(), name="result_create",),
    url(
    ...
    # Comparison set
    url(
        r"^study-population/(?P<pk>\d+)/comparison-set/create/$", views.ComparisonSetCreate.as_view(), name="cs_create",
    ),
    url(
    ...
    url(r"^comparison-set/(?P<pk>\d+)/update/$", views.ComparisonSetUpdate.as_view(), name="cs_update",),
    url(r"^comparison-set/(?P<pk>\d+)/delete/$", views.ComparisonSetDelete.as_view(), name="cs_delete",),
