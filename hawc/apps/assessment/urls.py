...
router.register(r"public", api.PublicAssessment, basename="public")
...
urlpatterns = [
    ...
    # attachment objects
    url(r"^(?P<pk>\d+)/attachment/create/$", views.AttachmentCreate.as_view(), name="attachment_create",),
    url(r"^attachment/(?P<pk>\d+)/$", views.AttachmentRead.as_view(), name="attachment_detail",),
    url(r"^attachment/(?P<pk>\d+)/update/$", views.AttachmentUpdate.as_view(), name="attachment_update",),
    ...
    url(r"^(?P<pk>\d+)/clean-extracted-data/", views.CleanExtractedData.as_view(), name="clean_extracted_data",),
    url(r"^assessment/(?P<pk>\d+)/effect-tags/create/$", views.EffectTagCreate.as_view(), name="effect_tag_create",),
    # helper functions
    ...
    url(r"^(?P<pk>\d+)/clean-study-metrics", views.CleanStudyRoB.as_view(), name="clean_study_metrics",),
    # api views
