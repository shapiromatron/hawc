    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveSmallIntegerField(
                        choices=[
                            (0, "IUR"),
                            (5, "OSF"),
                            (10, "Screening-Level RfD"),
                            (15, "Screening-Level RfC"),
                            (20, "Organ-Specific RfD"),
                            (25, "Organ-Specific RfC"),
                            (30, "Overall RfD"),
                            (35, "Overall RfC"),
                            (45, "Other"),
                        ],
                ...
                (
                    "value_unit",
                    models.CharField(blank=True, max_length=32, verbose_name="Value units"),
                ),
                (
                    "confidence",
                    models.CharField(
                ...
                ("dosimetric_approach", models.CharField(blank=True, max_length=128)),
                (
