# Generated by Django 3.2.14 on 2022-08-08 14:15
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("SCREEN_RFD", "Screening-Level RfD"),
                            ("SCREEN_RFC", "Screening-Level RfC"),
                            ("ORGAN_RFD", "Organ-Specific RfD"),
                            ("ORGAN_RFC", "Organ-Specific RfC"),
                            ("OVERALL_RFD", "Overall RfD"),
                            ("OVERALL_RFC", "Overall RfC"),
                            ("IUR", "IUR"),
                            ("OSF", "OSF"),
                            ("NONE", "No Value"),
                        ],
                ...
                (
                    "published",
                    models.DateField(blank=True, null=True, verbose_name="Date Published"),
                ),
                (
                    "uncertainty",
