...
ADAF_FOOTNOTE = (
    "An age-dependent adjustment factor (ADAF) has been applied to the value shown. Application of "
    "ADAFs is recommended in combination with appropriate exposure data when assessing risk "
    "associated with early-life exposure. More information is available in the comments field for "
    "this value."
)
