...
urlpatterns = [
    ...
    url(r"^reference/(?P<pk>\d+)/tag/$", views.TagByReference.as_view(), name="reference_tags_edit",),
    url(r"^tag/(?P<pk>\d+)/tag/$", views.TagByTag.as_view(), name="references_tags_edit"),
    url(r"^assessment/(?P<pk>\d+)/tag/untagged/$", views.TagByUntagged.as_view(), name="tag_untagged",),
    ...
    url(r"^assessment/(?P<pk>\d+)/references/topic-model/$", views.RefTopicModel.as_view(), name="topic_model",),
    ...
    url(r"^assessment/(?P<pk>\d+)/references/upload/$", views.RefUploadExcel.as_view(), name="ref_upload",),
    # CRUD searches
    ...
    url(
        r"^assessment/(?P<pk>\d+)/search/(?P<slug>[\w-]+)/update/$", views.SearchUpdate.as_view(), name="search_update",
    ),
    url(
        r"^assessment/(?P<pk>\d+)/search/(?P<slug>[\w-]+)/delete/$", views.SearchDelete.as_view(), name="search_delete",
    ),
    ...
    url(r"^assessment/(?P<pk>\d+)/ris-import/new/$", views.ImportRISNew.as_view(), name="import_ris_new",),
    # Edit tags
    url(
        r"^assessment/(?P<pk>\d+)/search/(?P<slug>[\w-]+)/tag/$", views.TagBySearch.as_view(), name="search_tags_edit",
    ),
    ...
    url(r"^ris-export-instructions/$", views.RISExportInstructions.as_view(), name="ris_export_instructions",),
