...
urlpatterns = [
    ...
    url(r"^assessment/(?P<pk>\d+)/text-edit/$", views.ARoBTextEdit.as_view(), name="arob_text_update",),
    # reporting
    url(r"^assessment/(?P<pk>\d+)/export/$", views.StudyRoBExport.as_view(), name="export",),
    url(r"^assessment/(?P<pk>\d+)/complete-export/$", views.StudyRoBCompleteExport.as_view(), name="complete_export",),
    # modify domains
    url(r"^assessment/(?P<pk>\d+)/domain/create/$", views.RoBDomainCreate.as_view(), name="robd_create",),
    ...
    # modify metrics
    url(r"^domain/(?P<pk>\d+)/metric/create/$", views.RoBMetricCreate.as_view(), name="robm_create",),
    ...
    # rob reviewers
    url(r"^assessment/(?P<pk>\d+)/study-assignments/$", views.ARoBReviewersList.as_view(), name="arob_reviewers",),
    url(
