# Generated by Django 3.2.10 on 2022-01-13 20:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("measurement_timing", models.CharField(blank=True, max_length=128)),
                (
                    "exposure_rank",
                ...
                ("statistical_method", models.CharField(blank=True, max_length=128)),
                ("comments", models.TextField(blank=True)),
                ("created", models.DateTimeField(auto_now_add=True)),
                ("last_updated", models.DateTimeField(auto_now=True)),
                (
