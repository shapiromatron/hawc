...
class InvitroStudyPrefilter(PrefilterBaseFilterSet):
    # studies
    ...
    effects = df.MultipleChoiceFilter(
        field_name="ivexperiments__endpoints__effect",
    ...
    categories = df.MultipleChoiceFilter(
        field_name="ivexperiments__endpoints__category",
    ...
    chemicals = df.MultipleChoiceFilter(
        field_name="ivexperiments__endpoints__chemical__name",
    ...
    effect_tags = df.MultipleChoiceFilter(
        field_name="ivexperiments__endpoints__effects",
    ...
    def filter_queryset(self, queryset):
        queryset = queryset.filter(assessment_id=self.assessment.pk, in_vitro=True)
