...
class EpiV1StudyPrefilter(PrefilterBaseFilterSet):
    # studies
    ...
    systems = df.MultipleChoiceFilter(
        field_name="study_populations__outcomes__system",
    ...
    effects = df.MultipleChoiceFilter(
        field_name="study_populations__outcomes__effect",
    ...
    effect_tags = df.MultipleChoiceFilter(
        field_name="study_populations__outcomes__effects",
