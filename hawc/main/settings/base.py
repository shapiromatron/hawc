...
PROJECT_PATH = str(Path(__file__).parents[2].resolve())
PROJECT_ROOT = str(Path(PROJECT_PATH).parents[1].resolve())

sys.path.extend([PROJECT_PATH, PROJECT_ROOT])
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': (
                ...
                'hawc.main.context_processors.from_settings',
            ),
        }
    },
]
