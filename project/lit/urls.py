...
urlpatterns = [
    ...
    url(r'^reference/(?P<pk>\d+)/tag/$',
        views.ReferenceTagsEdit.as_view(),
        name='reference_tags_edit'),
    url(r'^reference-tag/(?P<pk>\d+)/tag/$',
        views.TagsEditByTag.as_view(),
    ...
    url(r'^assessment/(?P<pk>\d+)/references/search/$',
        ...
        name='ref_search'),
    url(r'^assessment/(?P<pk>\d+)/references/json/$',
        views.RefsJSON.as_view(),
        name='refs_json'),
