...
var helpers = Object.assign({}, shared, {
    ...
    errorDict: {
        endpoints:
            'Filtering results contain more than 100 endpoints. Increase the quality threshold or include fewer effects.',
        effects: 'At least one effect must be chosen.',
        empty:
            'No endpoints were returned. Decrease the quality threshold or include more effects.',
    },
    formatErrors(error) {
