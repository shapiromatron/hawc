...
class RiskOfBiasMetric(models.Model):
    ...
    required_animal = models.BooleanField(
        ...
        help_text='Is this metric required for animal bioassay studies?<br> CAUTION: Removing requirement will destroy all bioassay responses for this metric.')
    required_epi = models.BooleanField(
        default=True,
        verbose_name='Required for epidemiology?',
        help_text='Is this metric required for human epidemiological studies?<br> CAUTION: Removing requirement will destroy all epi responses for this metric.')
    created = models.DateTimeField(
        auto_now_add=True)
    last_updated = models.DateTimeField(
        auto_now=True)
