        ...
        "emphasis": function(locale, options) {
            ...
            return "<li>" +
              "<div class='btn-group'>" +
                ...
                "<a class='btn" + size + "' data-wysihtml5-command='superscript' title='Superscript' tabindex='-1'>x<sup>2</sup></a>" +
                "<a class='btn" + size + "' data-wysihtml5-command='subscript' title='Subscript' tabindex='-1'>x<sub>2</sub></a>" +
              "</div>" +
            "</li>";
        },
