...
StudyVersion.field_order = ['short_citation', 'citation', 'hero_id',
                            'summary', 'updated'];
...
Study.prototype.add_attachments_row = function(div, attachments){
...
StudyQuality.prototype.build_details_div = function(options){
    var content = [];
    options = options || {};
...
StudyQuality.prototype._build_details_div = function(){
...
StudyQuality.display_details_divs = function($div, content){
...
StudyQuality.build_study_comparison_div = function(sqs){
...
StudyQuality.build_metric_comparison_div = function(sqs){
...
StudyQuality_Donut = function(study, plot_id, options){
    var self = this;
...
StudyQuality_Donut.prototype = new D3Plot();
StudyQuality_Donut.prototype.constructor = StudyQuality_Donut;

StudyQuality_Donut.prototype.set_defaults = function(options){
    this.w = 800;
    this.h = 400;
...
StudyQuality_Donut.prototype.build_plot = function(){
    this.plot_div.html('');
...
StudyQuality_Donut.prototype.customize_menu = function(){
    this.add_menu();
    var plot = this;
...
StudyQuality_Donut.prototype.toggle_lock_view = function(){
    this.plot_div.find('#lock_view').toggleClass("btn-info");
    this.viewlock = !this.viewlock;
};

StudyQuality_Donut.prototype.get_dataset_info = function(){
...
StudyQuality_Donut.prototype.draw_visualizations = function(){
    var self = this,
...
StudyQuality_Donut.prototype.toggle_domain_width = function(){
...
StudyQuality_Donut.prototype.clear_subset = function(){
  this.subset_div.empty();
};

StudyQuality_Donut.prototype.show_subset = function(metric){
    this.clear_subset();
...
StudyQuality_TblCompressed.prototype.build_table = function(){
    var self = this;
...
StudyQuality_TblCompressed.prototype.show_details_div = function(selected){
    var $sel = $(selected),
        divs = [],
        self = this,
...
StudyQuality_TblCompressed.prototype.build_tbody = function(){
...
StudyQuality_TblCompressed.prototype.build_footer = function(){
    var tfoot = $('<tfoot>'),
...
StudyQualityAggregation = function(studies){
    this.studies = studies;
    this.metrics_dataset = this.build_metrics_dataset();
};

StudyQualityAggregation.prototype.build_metrics_dataset = function(){
    var arr = [];
...
StudyQualityAggregation_Heatmap = function(sq_agg, plot_div, details_div, options){
...
StudyQualityAggregation_Heatmap.prototype = new D3Plot();
StudyQualityAggregation_Heatmap.prototype.constructor = StudyQualityAggregation_Heatmap;

StudyQualityAggregation_Heatmap.prototype.build_plot = function(){
    this.plot_div.html('');
    this.get_dataset();
    this.get_plot_sizes();
    this.build_plot_skeleton(false);
...
StudyQualityAggregation_Heatmap.prototype.resize_plot_dimensions = function(){
...
StudyQualityAggregation_Heatmap.prototype.get_plot_sizes = function(){
...
StudyQualityAggregation_Heatmap.prototype.set_defaults = function(){
    this.padding = {top:10, right:10, bottom:10, left:10};
...
StudyQualityAggregation_Heatmap.prototype.get_dataset = function(){
...
StudyQualityAggregation_Heatmap.prototype.add_axes = function() {
...
StudyQualityAggregation_Heatmap.prototype.draw_visualizations = function(){
    var x = this.x_scale,
        y = this.y_scale,
        width = this.cell_px,
        half_width = width/2,
...
StudyQualityAggregation_Heatmap.prototype._modal_sizing = function(){
...
StudyQualityAggregation_Heatmap.prototype.draw_hovers = function(v, options){
...
StudyQualityAggregation_Heatmap.prototype.print_details = function(d){
    var divs = [],
        self = this;
...
StudyQualityAggregation_Stacked = function(sq_agg, plot_div, options){
...
StudyQualityAggregation_Stacked.prototype = new D3Plot();
StudyQualityAggregation_Stacked.prototype.constructor = StudyQualityAggregation_Stacked;

StudyQualityAggregation_Stacked.prototype.build_plot = function(){
    this.plot_div.html('');
    this.get_dataset();
    this.get_plot_sizes();
...
StudyQualityAggregation_Stacked.prototype.resize_plot_dimensions = function(){
    // Resize plot based on the dimensions of the labels.
...
StudyQualityAggregation_Stacked.prototype.get_plot_sizes = function(){
    this.h = this.cell_px*this.metrics.length;
    var menu_spacing = (this.options.show_menu_bar) ? 40 : 0;
    this.plot_div.css({'height': (this.h + this.padding.top + this.padding.bottom +
        menu_spacing) + 'px'});
...
StudyQualityAggregation_Stacked.prototype.set_defaults = function(){
...
StudyQualityAggregation_Stacked.prototype.get_dataset = function(){
...
StudyQualityAggregation_Stacked.prototype.add_axes = function() {
    $.extend(this.x_axis_settings, {
        rangeRound: [0, this.w],
        number_ticks: 5,
        x_translate: 0,
...
StudyQualityAggregation_Stacked.prototype.draw_visualizations = function(){
    var plot = this,
        x = this.x_scale,
        y = this.y_scale,
