...
CommentManager.prototype = {
    ...
    _display_comments: function($div){
        var content = [];
    ...
    _build_comment_list: function(lst){
    ...
    _create_comment_form: function($form){
    ...
    insert_inline_comment_form: function(){
        this._create_comment_form(this.$comments_form);
    },
    _comments_summary_table: function(){
    ...
    build_popup_button: function($obj){
