...
StudyQualityMatrix.prototype = new D3Plot();
StudyQualityMatrix.prototype.constructor = StudyQualityMatrix;

StudyQualityMatrix.prototype.set_defaults = function(options){
...
StudyQualityMatrix.prototype.build_plot = function(){
    this.plot_div.html('');
...
StudyQualityMatrix.prototype.customize_menu = function(){
    this.add_menu();
    if (this.parent){this.parent.add_toggle_button(this);}
};

StudyQualityMatrix.prototype.get_dataset_info = function(){
...
StudyQualityMatrix.prototype.add_axes = function(){
...
StudyQualityMatrix.prototype.build_labels_information = function(){
    this.add_title();
    // this.build_x_label();
    // this.build_y_label();
...
StudyQualityMatrix.prototype.draw_visualizations = function(){
