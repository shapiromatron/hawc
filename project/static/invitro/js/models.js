...
IVChemical.prototype = {
    build_details_table: function(){
        ...
        tbl.add_tbody_tr("Chemical name", this.data.name);
        tbl.add_tbody_tr("CAS", this.data.cas);
        tbl.add_tbody_tr("CAS inferred?", HAWCUtils.booleanCheckbox(this.data.cas_inferred));
        tbl.add_tbody_tr("CAS notes", this.data.cas_notes);
        tbl.add_tbody_tr("Source", this.data.source);
        tbl.add_tbody_tr("Purity", this.data.purity);
        tbl.add_tbody_tr("Purity confirmed?", HAWCUtils.booleanCheckbox(this.data.purity_confirmed));
