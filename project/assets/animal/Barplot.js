...
class Barplot extends D3Plot {
    ...
    add_error_bars(){
        ...
        var bar_options = {
            data: bars,
            x1(d) {return x(d.dose)+x.rangeBand()/2;},
            y1(d) {return y(d.low);},
            x2(d) {return x(d.dose)+x.rangeBand()/2;},
            y2(d) {return y(d.high);},
            classes: 'dr_err_bars',
        ...
        $.extend(bar_options, {
            x1(d,i) {return x(d.dose) + x.rangeBand()/2 - hline_width;},
            y1(d) {return y(d.low);},
            x2(d,i) {return x(d.dose) + x.rangeBand()/2 + hline_width;},
            y2(d) {return y(d.low);},
        });
