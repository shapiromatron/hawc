    ...
    x_axis_change_chart_update(){
        ...
        this.vis.selectAll('.x_axis')
            ...
            .each('end', function(){
                ...
                var min_label = d3.selectAll('.x_axis text').filter(function(){return $(this).text()===min;});
                min_label.text(0);
            });
    ...
    add_dr_error_bars(update){
        ...
        var bars = this.values.filter(function(v){
            ...
            bar_options  = {
                data: bars,
                x1(d) {return x(d.x);},
                y1(d) {return y(d.y_lower);},
                x2(d) {return x(d.x);},
                y2(d) {return y(d.y_upper);},
                classes: 'dr_err_bars',
        ...
        $.extend(bar_options, {
            x1(d,i) {return x(d.x) + hline_width;},
            y1(d) {return y(d.y_lower);},
            x2(d,i) {return x(d.x) - hline_width;},
            y2(d) {return y(d.y_lower);},
        });
