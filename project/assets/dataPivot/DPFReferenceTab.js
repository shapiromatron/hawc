...
let buildReferenceLines = function(tab, dp){
        let thead = $('<thead>').html(buildHeaderTr(['Reference line value', 'Line style', 'Delete'])),
            tbody = $('<tbody>'),
        ...
        tab.append(
            $('<h3>Reference lines</h3>').append(newRowBtn),
            tbl
        );
    },
    buildReferenceRanges = function(tab, dp){
        let thead = $('<thead>').html(buildHeaderTr(['Lower value', 'Upper value', 'Range style', 'Delete'])),
            colgroup = $('<colgroup><col style="width: 25%;"><col style="width: 25%;"><col style="width: 25%;"><col style="width: 25%;"></colgroup>'),
            tbody = $('<tbody>'),
            tbl = $('<table class="table table-condensed table-bordered">').html([colgroup, thead, tbody]),
        ...
        tab.append(
            $('<h3>Reference ranges</h3>').append(newRowBtn),
            tbl
        );
    },
