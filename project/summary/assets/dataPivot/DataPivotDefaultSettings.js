...
export default {
    ...
    styles: {
        ...
        rectangles: [
            ...
            {name: 'black',   fill: '#000000', 'fill-opacity': 0.8, 'stroke': '#FFFFFF', 'stroke-width': 1},
            {name: 'red',     fill: '#e32727', 'fill-opacity': 0.8, 'stroke': '#6f0000', 'stroke-width': 1},
            {name: 'green',   fill: '#22ba53', 'fill-opacity': 0.8, 'stroke': '#006a1e', 'stroke-width': 1},
            {name: 'blue',    fill: '#3aa4e5', 'fill-opacity': 0.8, 'stroke': '#006dbe', 'stroke-width': 1},
            {name: 'orange',  fill: '#ffb100', 'fill-opacity': 0.8, 'stroke': '#dc8f00', 'stroke-width': 1},
            {name: 'purple',  fill: '#b82cff', 'fill-opacity': 0.8, 'stroke': '#5e5e5e', 'stroke-width': 1},
            {name: 'fuschia', fill: '#d4266e', 'fill-opacity': 0.8, 'stroke': '#ab006c', 'stroke-width': 1},
        ],
    },
};
