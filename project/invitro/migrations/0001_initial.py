    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cas_notes', models.CharField(max_length=256, verbose_name=b'CAS determination notes')),
                ('source', models.CharField(max_length=128, verbose_name=b'Source of chemical')),
                ('purity', models.CharField(help_text=b'Ex: >99%, not-reported, etc.', max_length=32, verbose_name=b'Chemical purity')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('short_description', models.CharField(help_text=b'Short (<128 character) description of effect & measurement', max_length=128)),
                ('effect', models.CharField(help_text=b'Effect, using common-vocabulary', max_length=128)),
                ...
                ('overall_pattern', models.PositiveSmallIntegerField(default=0, choices=[(0, b'not-available'), (1, b'increase'), (2, b'increase, then decrease'), (6, b'increase, then no change'), (3, b'decrease'), (4, b'decrease, then increase'), (7, b'decrease, then no change'), (5, b'no clear pattern')])),
                ...
                ('trend_test_notes', models.CharField(help_text=b'Notes describing details on the trend-test performed', max_length=256, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cytotoxicity_observed', models.NullBooleanField(default=None, choices=[(None, b'not reported'), (False, b'not observed'), (True, b'observed')])),
                ('precipitation_observed', models.NullBooleanField(default=None, choices=[(None, b'not reported'), (False, b'not observed'), (True, b'observed')])),
