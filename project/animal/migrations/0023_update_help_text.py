...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.CharField(choices=[('NR', 'Not-reported'), ('UN', 'Untreated'), ('VT', 'Vehicle-treated'), ('B', 'Untreated + Vehicle-treated'), ('Y', 'Yes (untreated and/or vehicle)'), ('N', 'No')], default='VT', help_text='Description of negative-controls used', max_length=2),
        ),
        migrations.AlterField(
            model_name='dosingregime',
        ...
        migrations.AlterField(
            ...
            field=models.PositiveSmallIntegerField(choices=[(3, 'increase from reference/control group'), (2, 'decrease from reference/control group'), (1, 'any change from reference/control group'), (0, 'not reported'), (4, '---')], default=4, help_text='Response direction which would be considered adverse', verbose_name='Expected response adversity direction'),
        ),
        migrations.AlterField(
            model_name='endpoint',
            name='monotonicity',
            field=models.PositiveSmallIntegerField(choices=[(8, '--'), (0, 'N/A, single dose level study'), (1, 'N/A, no effects detected'), (2, 'yes, visual appearance of monotonicity but no trend'), (3, 'yes, monotonic and significant trend'), (4, 'yes, visual appearance of non-monotonic but no trend'), (5, 'yes, non-monotonic and significant trend'), (6, 'no pattern'), (7, 'unclear'), (8, 'not-reported')], default=8),
        ),
        migrations.AlterField(
            model_name='endpoint',
            name='observation_time_units',
            field=models.PositiveSmallIntegerField(choices=[(0, 'not reported'), (1, 'seconds'), (2, 'minutes'), (3, 'hours'), (4, 'days'), (5, 'weeks'), (6, 'months'), (9, 'years'), (7, 'post-natal day (PND)'), (8, 'gestational day (GD)')], default=0),
        ),
        migrations.AlterField(
            model_name='endpoint',
            name='organ',
