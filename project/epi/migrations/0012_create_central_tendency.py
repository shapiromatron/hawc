...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='description',
            field=models.TextField(blank=True, help_text='Provide additional comparison set or extraction details if necessary'),
        ),
        migrations.AlterField(
            model_name='comparisonset',
            name='exposure',
        ...
        migrations.AlterField(
            ...
            field=models.CharField(blank=True, help_text="Enter exposure distribution details not noted in fields below. Ex. 25th percentile=1.18; 75th percentile=3.33<span class='help-text-notes'>Typically 25th and 75th percentiles or alternative central tendency estimate</span>", max_length=128),
        ),
        migrations.AlterField(
            model_name='exposure',
            name='measured',
            field=models.CharField(blank=True, help_text='Chemical measured in study; typically, the same as chemical exposure, but occasionally chemical exposure metabolite or another chemical signal. Use abbreviation. Ex PFNA; MEHP', max_length=128, verbose_name='What was measured'),
        ),
        migrations.AlterField(
            model_name='exposure',
            name='metric',
        ...
        migrations.AlterField(
            model_name='exposure',
            name='metric_units',
            field=models.ForeignKey(help_text="Note chemical measurement units (metric system); if no units given, that is, chemical exposure assumed from occupation or survey data, note appropriate exposure categories. Ex. ng/mL; Y/N; electroplating/welding/other<span class='important-note'>This field is commonly used in HAWC visualizations</span>", on_delete=django.db.models.deletion.CASCADE, to='assessment.DoseUnits'),
        ),
        migrations.AlterField(
            model_name='exposure',
            name='n',
            field=models.PositiveIntegerField(blank=True, help_text="<span class='help-text-notes optional'>Optional</span><span class='optional'>Number of individuals where exposure was measured</span>", null=True),
        ),
        migrations.AlterField(
            model_name='exposure',
            name='name',
            field=models.CharField(help_text='Name of chemical exposure; use abbreviation. Ex. PFNA; DEHP', max_length=128),
        ),
        migrations.AlterField(
            model_name='exposure',
            name='sampling_period',
            field=models.CharField(blank=True, help_text="Exposure sampling period<span class='help-text-notes optional'>Optional</span>", max_length=128),
        ),
        migrations.AlterField(
            model_name='group',
            name='comments',
            field=models.TextField(blank=True, help_text='Provide additional group or extraction details if necessary'),
        ),
        migrations.AlterField(
            model_name='group',
        ...
        migrations.AlterField(
            model_name='group',
            name='eligible_n',
            field=models.PositiveIntegerField(blank=True, help_text='Optional', null=True, verbose_name='Eligible N'),
        ),
        migrations.AlterField(
            model_name='group',
            name='ethnicities',
        ...
        migrations.AlterField(
            model_name='group',
            name='invited_n',
            field=models.PositiveIntegerField(blank=True, help_text='Optional', null=True, verbose_name='Invited N'),
        ),
        migrations.AlterField(
            model_name='group',
            name='isControl',
            field=models.NullBooleanField(choices=[(True, 'Yes'), (False, 'No'), (None, 'N/A')], default=None, help_text='Should this group be interpreted as a null/control group, if applicable', verbose_name='Control?'),
        ),
        migrations.AlterField(
            model_name='group',
            name='name',
            field=models.CharField(help_text='First note "Cases" or "Controls" if applicable, then "Continuous" for continuous exposure or the appropriate quartile/tertile/etc. for categorial ("Q1", "Q2", etc). Ex. Cases Q3; Continuous', max_length=256),
        ),
        migrations.AlterField(
            model_name='group',
            name='numeric',
            field=models.FloatField(blank=True, help_text='For categorical, note position in which groups should be listed in visualizations. Ex. Q1: 1 This field is commonly used in HAWC visualizations', null=True, verbose_name='Numerical value (sorting)'),
        ),
        migrations.AlterField(
            model_name='group',
            name='participant_n',
            field=models.PositiveIntegerField(blank=True, help_text='Ex. 1400', null=True, verbose_name='Participant N'),
        ),
        migrations.AlterField(
            model_name='groupresult',
            name='estimate',
            field=models.FloatField(blank=True, help_text='Central tendency estimate for group.This field is commonly used in HAWC visualizations', null=True),
        ),
        migrations.AlterField(
            model_name='groupresult',
            name='is_main_finding',
            field=models.BooleanField(help_text='If study does not report a statistically significant association (p<0.05) between exposure and health outcome at any exposure level, check "Main finding" for highest exposure group compared with referent group (e.g.Q4 vs. Q1). If study reports a statistically significant association and monotonic dose response, check "Main finding" for lowest exposure group with a statistically significant association. If nonmonotonic dose response, case-by-case considering statistical trend analyses, consistency of pattern across exposure groups, and/or biological significance.  See "Results" section of https://ehp.niehs.nih.gov/1205502/ for examples and further details. This field is commonly used in HAWC visualizations', verbose_name='Main finding'),
        ),
        migrations.AlterField(
            model_name='groupresult',
            name='lower_ci',
            field=models.FloatField(blank=True, help_text='Numerical value for lower-confidence interval, when available.This field is commonly used in HAWC visualizations', null=True, verbose_name='Lower CI'),
        ),
        migrations.AlterField(
            model_name='groupresult',
            name='lower_range',
            field=models.FloatField(blank=True, help_text='Numerical value for lower range, when available.This field is commonly used in HAWC visualizations', null=True, verbose_name='Lower range'),
        ),
        migrations.AlterField(
            model_name='groupresult',
            name='main_finding_support',
            field=models.PositiveSmallIntegerField(choices=[(3, 'not-reported'), (2, 'supportive'), (1, 'inconclusive'), (0, 'not-supportive')], default=1, help_text='Select appropriate level of support for the main finding.See "Results" section of https://ehp.niehs.nih.gov/1205502/ for examples and further details. Choose between "inconclusive" vs. "not-supportive" based on chemical- and study-specific context. This field is commonly used in HAWC visualizations'),
        ),
        migrations.AlterField(
            model_name='groupresult',
            name='n',
            field=models.PositiveIntegerField(blank=True, help_text='Individuals in group where outcome was measured.This field is commonly used in HAWC visualizations', null=True),
        ),
        migrations.AlterField(
            model_name='groupresult',
            name='p_value',
            field=models.FloatField(blank=True, help_text='Note p-value when available. This field is commonly used in HAWC visualizations', null=True, validators=[django.core.validators.MinValueValidator(0.0), django.core.validators.MaxValueValidator(1.0)], verbose_name='p-value'),
        ),
        migrations.AlterField(
            model_name='groupresult',
            name='p_value_qualifier',
            field=models.CharField(choices=[(' ', '-'), ('-', 'n.s.'), ('<', '<'), ('=', '='), ('>', '>')], default='-', help_text='Select n.s. if results are not statistically significant; otherwise, choose the appropriate qualifier. This field is commonly used in HAWC visualizations', max_length=1, verbose_name='p-value qualifier'),
        ),
        migrations.AlterField(
            model_name='groupresult',
            name='upper_ci',
            field=models.FloatField(blank=True, help_text='Numerical value for upper-confidence interval, when available.This field is commonly used in HAWC visualizations', null=True, verbose_name='Upper CI'),
        ),
        migrations.AlterField(
            model_name='groupresult',
            name='upper_range',
            field=models.FloatField(blank=True, help_text='Numerical value for upper range, when available.This field is commonly used in HAWC visualizations', null=True, verbose_name='Upper range'),
        ),
        migrations.AlterField(
            model_name='groupresult',
            name='variance',
            field=models.FloatField(blank=True, help_text='Variance estimate for group, when available.This field is commonly used in HAWC visualizations', null=True, verbose_name='Variance'),
        ),
        migrations.AlterField(
            model_name='outcome',
        ...
        migrations.AlterField(
            ...
            field=models.TextField(help_text='Copy and paste diagnostic methods directly from study. Ex. "Birth weight (grams) was measured by trained midwives at delivery." <span class=\'help-text-notes\'>Use quotation marks around direct quotes from a study</span>'),
        ),
        migrations.AlterField(
            model_name='outcome',
            name='effect',
            field=models.CharField(blank=True, help_text='Effect, using common-vocabulary. Use title style (capitalize all words). Ex. Thyroid Hormones', max_length=128),
        ),
        migrations.AlterField(
            model_name='outcome',
            name='effect_subtype',
            field=models.CharField(blank=True, help_text="Effect subtype, using common-vocabulary. Use title style (capitalize all words). Ex. Absolute<span class='help-text-notes'>This field is not mandatory; often no effect subtype is necessary</span>", max_length=128),
        ),
        migrations.AlterField(
            model_name='outcome',
            name='outcome_n',
            field=models.PositiveIntegerField(blank=True, help_text='Number of individuals for whom outcome was reported. Ex. 132', null=True, verbose_name='Outcome N'),
        ),
        migrations.AlterField(
            model_name='outcome',
            name='summary',
            field=models.TextField(blank=True, help_text='Provide additional outcome or extraction details if necessary. Ex. No association (data not shown)'),
        ),
        migrations.AlterField(
            model_name='outcome',
            name='system',
            field=models.CharField(blank=True, help_text='Primary biological system affected', max_length=128),
        ),
        migrations.AlterField(
            model_name='result',
            name='ci_units',
        ...
        migrations.AlterField(
            model_name='result',
            name='comments',
            field=models.TextField(blank=True, help_text='Summarize main findings (optional) or describe why no details are presented. Ex. No association (data not shown)'),
        ),
        migrations.AlterField(
            model_name='result',
            name='data_location',
            field=models.CharField(blank=True, help_text='Details on where the data are found in the literature. Ex. Figure 1; Supplemental Table 2', max_length=128),
        ),
        migrations.AlterField(
            model_name='result',
            name='dose_response',
            field=models.PositiveSmallIntegerField(choices=[(0, 'not-applicable'), (1, 'monotonic'), (2, 'non-monotonic'), (3, 'no trend'), (4, 'not reported')], default=0, help_text="<span class='help-text-notes optional'>Optional</span>", verbose_name='Dose Response Trend'),
        ),
        migrations.AlterField(
            model_name='result',
            name='dose_response_details',
            field=models.TextField(blank=True, help_text="<span class='help-text-notes optional'>Optional</span>"),
        ),
        migrations.AlterField(
            model_name='result',
            name='metric',
        ...
        migrations.AlterField(
            model_name='result',
            name='name',
            field=models.CharField(help_text="Name the result, following the format <b>Effect Exposure (If log-transformed) (continuous, quartiles, tertiles, etc.) – subgroup</b>. Ex. Hyperthyroidism PFHxS (ln) (continuous) – women<span class='important-note'>This field is commonly used in HAWC visualizations</span>", max_length=256),
        ),
        migrations.AlterField(
            model_name='result',
            name='population_description',
            field=models.CharField(blank=True, help_text="Describe the population subset studied for this outcome, following the format <b>Male or female adults or children (n)</b>. Ex. Women (n=1200); Newborn girls (n=33)<span class='important-note'>This field is commonly used in HAWC visualizations</span>", max_length=128),
        ),
        migrations.AlterField(
            model_name='result',
            name='prevalence_incidence',
            field=models.CharField(blank=True, help_text="<span class='help-text-notes optional'>Optional</span>", max_length=128, verbose_name='Overall incidence prevalence'),
        ),
        migrations.AlterField(
            model_name='result',
        ...
        migrations.AlterField(
            model_name='result',
            name='trend_test',
            field=models.CharField(blank=True, help_text="<span class='help-text-notes optional'>Optional</span><span class='optional'>Enter result, if available (ex: p=0.015, p≤0.05, n.s., etc.)</span>", max_length=128, verbose_name='Trend test result'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='studypopulation',
            name='design',
            field=models.CharField(choices=[('CO', 'Cohort'), ('CX', 'Cohort (Retrospective)'), ('CY', 'Cohort (Prospective)'), ('CC', 'Case-control'), ('NC', 'Nested case-control'), ('CR', 'Case report'), ('SE', 'Case series'), ('RT', 'Randomized controlled trial'), ('NT', 'Non-randomized controlled trial'), ('CS', 'Cross-sectional')], help_text="Choose the most specific description of study design.<span class='important-note'>This field is commonly used in HAWC visualizations</span>", max_length=2),
        ),
        migrations.AlterField(
            model_name='studypopulation',
            name='eligible_n',
            field=models.PositiveIntegerField(blank=True, help_text="<span class='help-text-notes optional'>Optional</span><span class='optional'>Number of individuals eligible based on study design and inclusion/exclusion criteria.</span>", null=True, verbose_name='Eligible N'),
        ),
        migrations.AlterField(
            model_name='studypopulation',
            name='invited_n',
            field=models.PositiveIntegerField(blank=True, help_text="<span class='help-text-notes optional'>Optional</span><span class='optional'>Number of individuals initially asked to participate in the study.</span>", null=True, verbose_name='Invited N'),
        ),
        migrations.AlterField(
            model_name='studypopulation',
            name='name',
            field=models.CharField(help_text="Name the population associated with the study, following the format <b>Study name (years study conducted), Country, number participants (number male, number female, if relevant).</b> Ex. INUENDO (2002-2004), Greenland/Poland/Ukraine, 1,321 mother-infant pairs; NHANES (2007-2010), U.S., 1,181 adults (672 men, 509 women). <span class='help-text-notes'>Use men/women for adults (>=18), boys/girls for children (<18).</span><span class='help-text-notes'>Note pregnant women if applicable.</span><span class='help-text-notes'>There may be multiple study populations within a single study, though this is typically unlikely.</span><span class='important-note'>This field is commonly used in HAWC visualizations</span>", max_length=256),
        ),
        migrations.AlterField(
            model_name='studypopulation',
            name='participant_n',
            field=models.PositiveIntegerField(blank=True, help_text="How many individuals participated in the study? Ex. 1321<br/><span class='help-text-notes'>If mother-infant pairs, note number of pairs, not total individuals studied</span>", null=True, verbose_name='Participant N'),
        ),
        migrations.AlterField(
            model_name='studypopulation',
            name='region',
            field=models.CharField(blank=True, help_text="<span class='help-text-notes optional'>Optional</span>", max_length=128),
        ),
        migrations.AlterField(
            model_name='studypopulation',
            name='source',
            field=models.CharField(blank=True, help_text='Population source (General population, Occupational cohort, Superfund site, etc.). Ex. General population', max_length=128),
        ),
        migrations.AlterField(
            model_name='studypopulation',
            name='state',
