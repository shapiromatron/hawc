...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('name', models.CharField(help_text=b'Name of exposure-route', max_length=128)),
                ...
                ('sampling_period', models.CharField(help_text=b'Exposure sampling period', max_length=128)),
