...
urlpatterns = [
    ...
    url(r'^assessment/(?P<pk>\d+)/risk-of-bias/report/$', views.StudyBiasExport.as_view(), name='bias_export'),
    url(r'^assessment/(?P<pk>\d+)/risk-of-bias/fixed-report/$', views.SQFixedReport.as_view(), name='sq_fixedreport'),

    url(r'^assessment/(?P<pk>\d+)/risk-of-bias-domain/create/$', views.SQDomainCreate.as_view(), name='sqd_create'),
    url(r'^risk-of-bias-domain/(?P<pk>\d+)/edit/$', views.SQDomainUpdate.as_view(), name='sqd_update'),
    url(r'^risk-of-bias-domain/(?P<pk>\d+)/delete/$', views.SQDomainDelete.as_view(), name='sqd_delete'),

    url(r'^risk-of-bias-domain/(?P<pk>\d+)/metric/create/$', views.SQMetricCreate.as_view(), name='sqm_create'),
    url(r'^risk-of-bias-metric/(?P<pk>\d+)/edit/$', views.SQMetricUpdate.as_view(), name='sqm_update'),
    url(r'^risk-of-bias-metric/(?P<pk>\d+)/delete/$', views.SQMetricDelete.as_view(), name='sqm_delete'),
    ...
    url(r'^(?P<pk>\d+)/risk-of-bias/$', views.SQsDetail.as_view(), name='sqs_detail'),
    url(r'^(?P<pk>\d+)/risk-of-bias/create/$', views.SQsCreate.as_view(), name='sqs_new'),
    url(r'^(?P<pk>\d+)/risk-of-bias/edit/$', views.SQsEdit.as_view(), name='sqs_update'),
    url(r'^(?P<pk>\d+)/risk-of-bias/delete/$', views.SQsDelete.as_view(), name='sqs_delete'),

    # risk-of-bias
    url(r'^risk-of-bias/(?P<slug>[\w-]+)/(?P<pk>\d+)/create/', views.SQCreate.as_view(), name='sq_create'),
    url(r'^risk-of-bias/(?P<pk>\d+)/edit/$', views.SQEdit.as_view(), name='sq_update'),
